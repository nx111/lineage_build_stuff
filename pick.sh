...
kpick 240888 # Remove extra $ in soong_app_prebuilt
...
# frameworks/base
kpick 240889 # SystemUI: Fix some issues with clock position
...
kpick 240957 # livedisplay: Fix racy init
kpick 240961 # livedisplay: sdm: Fix restoring default mode
